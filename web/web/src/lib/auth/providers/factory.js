...
import { AzureOAuthProvider } from './azure'
...
class OAuthProviderFactory {
  ...
  async _initializeProvider() {
    try {
      ...
      const providerType = config['gravitino.authenticator.oauth.provider']?.toLowerCase() || 'generic'

      console.log('[OAuthProviderFactory] Detected provider type:', providerType)
