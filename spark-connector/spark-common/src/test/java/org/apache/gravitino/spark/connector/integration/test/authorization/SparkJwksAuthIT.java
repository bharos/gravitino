  ...
  public void startIntegrationTest() throws Exception {
    ...
    SparkConf sparkConf =
        new SparkConf()
            ...
            .set("spark.sql.gravitino.uri", serverUri)
            .set("spark.sql.gravitino.metalake", METALAKE)
            ...
            .set(
                "spark.sql.gravitino." + AuthProperties.GRAVITINO_CLIENT_AUTH_TYPE,
                AuthProperties.OAUTH2_AUTH_TYPE)
            .set(
                "spark.sql.gravitino." + AuthProperties.GRAVITINO_OAUTH2_SERVER_URI,
                "http://localhost:" + serverPort)
            .set("spark.sql.gravitino." + AuthProperties.GRAVITINO_OAUTH2_TOKEN_PATH, "token")
            ...
            .set(
                "spark.sql.gravitino." + AuthProperties.GRAVITINO_OAUTH2_CREDENTIAL,
                "test-client:test-secret")
            .set("spark.sql.gravitino." + AuthProperties.GRAVITINO_OAUTH2_SCOPE, "openid");
